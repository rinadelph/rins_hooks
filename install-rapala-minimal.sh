...
echo "  • rapala-router - Routes commands through Rapala"
echo "  • rapala-command - Handles command execution"
echo ""
...
echo "  • List hooks: ./bin/rapala hook list"
echo "  • Enable hook: ./bin/rapala hook enable <name>"
echo "  • Disable hook: ./bin/rapala hook disable <name>"
echo ""
